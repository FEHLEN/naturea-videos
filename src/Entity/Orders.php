...
class Orders
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=OrderDetails::class, mappedBy="lienOrder")
     */
    ...
    public function removeOrderDetail(OrderDetails $orderDetail): self
    {
        if ($this->orderDetails->removeElement($orderDetail)) {
            ...
            if ($orderDetail->getLienOrder() === $this) {
                $orderDetail->setLienOrder(null);
            }
        }
